...
public class MySqliteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        StringBuffer createAlarmTable =
                new StringBuffer().append("CREATE TABLE ").append(TABLE_ALARM + " (")
                        ...
                        .append(COLUMN_ID_EVENT).append(" TEXT, ")
    ...
    public long addAlarm(ItemAlarm itemAlarm) throws SQLiteException {
        ...
        if (itemAlarm != null) {
            cv.put(COLUMN_ID_EVENT, itemAlarm.getIdEvent());
    ...
    public ItemAlarm getAlarm(int id) throws SQLiteException {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            itemAlarm.setIdEvent(cursor.getString(cursor.getColumnIndex(COLUMN_ID_EVENT)));
            ...
            Type type = new TypeToken<HashMap<ItemAlarm.WeekDay, Boolean>>() {
            }.getType();
